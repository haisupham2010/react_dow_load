...
export default function Contactus() {
    ...
    const handleFormSubmit = (event) => {
        ...
        // TODO: call API 
      const url_api = "https://tuongdoirong.com/api/node.php?f=inst&database=mindx&mytable=info_khach&cot=firstname,email,phone,message&gt='"+ credential.firstname +"','"+ credential.email +"','"+ credential.phone +"','"+  credential.message   +"'"
    ...
    return (
        <div className="container">
            <div className="row align-items-center justify-content-center">
                ...
                <div className='d-flex flex-column align-items-center' style={{ gap: "3px", width: "100%" }}>
                ...
                <div className='d-flex flex-column align-items-center justify-content-center' style={{ borderRadius: "3%", marginTop: "40px", backgroundColor: "white", width: "800px", height: "800px" }}>
                    ...
                    <div className="" style={{ width: "90%", height: "90%" }}>
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <div className='mt-5'>
                                Message
                                <div>
                                    <textarea style={{ width: "100%", height: "200px" }} placeholder="Enter your message..."
                                        name="message"
                                    ...
                                    <button type="submit" style={{ color: "white" }} className="btn btn-dark mt-4">
                                        Send Message
                                    </button>
                                    <div>
