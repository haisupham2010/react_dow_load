...
export default function Aboutusmenu() {
    ...
    return (
        <div>
            ...
            <div className="position-relative d-flex align-items-center justify-content-center cartext_img_but" style={{  backgroundColor: "#ebe9eb" }}>
                <Card_text_but_img />
            </div>
            <div className="d-flex align-items-center justify-content-center" style={{ height: "600px" }}>
                <Car_text_img />
            </div>
            <div className="d-flex align-items-center justify-content-center cartext_text" style={{  backgroundColor: "#ebe9eb" }}>
                <Car_text_text />
            </div>
